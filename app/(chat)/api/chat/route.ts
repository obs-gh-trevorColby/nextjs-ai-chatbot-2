...
// Initialize metrics
const chatRequestCounter = meter.createCounter("chat_request_count", {
  description: "Total number of chat requests",
});

const chatRequestDuration = meter.createHistogram("chat_request_duration", {
  description: "Duration of chat requests in milliseconds",
});

const chatErrorCounter = meter.createCounter("chat_error_count", {
  ...
  return tracer.startActiveSpan("chat.post", async (span) => {
    ...
    try {
      ...
      span.setAttributes({
        ...
        "chat.message_role": message.role,
      });
