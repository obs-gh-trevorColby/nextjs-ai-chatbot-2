...
// Configuration
const serviceName = "ai-chatbot"; // matches the service name from existing instrumentation.ts
...
export function initOtel() {
  try {
    ...
    logger.emit({
      ...
      severityText: "INFO",
      body: "OpenTelemetry SDK started for ai-chatbot",
    });
  } catch (error) {
...
// Export tracer and meter - these should be called after initOtel()
