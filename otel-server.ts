...
const otlpEndpoint = process.env.OBSERVE_INGEST_TOKEN
...
const resource = resourceFromAttributes({
  ...
  ...(process.env.OBSERVE_CUSTOMER_ID && {
    "observe.customer_id": process.env.OBSERVE_CUSTOMER_ID,
  }),
});
...
export const sdk = new NodeSDK({
  ...
  instrumentations: [
    getNodeAutoInstrumentations({
      // Disable some instrumentations that might be noisy or not needed
