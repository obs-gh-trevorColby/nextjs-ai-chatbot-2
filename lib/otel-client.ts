...
const otlpEndpoint = process.env.NEXT_PUBLIC_OBSERVE_CUSTOMER_ID
  ? `https://${process.env.NEXT_PUBLIC_OBSERVE_CUSTOMER_ID}.collect.observeinc.com`
...
// Export logger for use in client components
